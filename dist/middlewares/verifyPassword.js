...
exports.verifyPassMiddleware = void 0;
var User_1 = __importDefault(require("../models/User"));
var bcrypt_1 = require("bcrypt");
var jwt = require('jsonwebtoken');
var verifyPassMiddleware = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (user) { // if found the email
                            (0, bcrypt_1.compare)(pass, user.password).then(function (result) {
                                if (result) {
                                    console.log('passou');
                                    next();
                                }
...
exports.verifyPassMiddleware = verifyPassMiddleware;
