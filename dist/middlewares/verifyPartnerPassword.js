...
exports.verifyPartnerPassMiddleware = void 0;
var Partner_1 = __importDefault(require("../models/Partner"));
var bcrypt_1 = require("bcrypt");
var jwt = require('jsonwebtoken');
var verifyPartnerPassMiddleware = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (partner) { // if found the email
                            (0, bcrypt_1.compare)(pass, partner.password).then(function (result) {
                                if (result) {
                                    next();
                                }
                                if (!result) {
...
exports.verifyPartnerPassMiddleware = verifyPartnerPassMiddleware;
